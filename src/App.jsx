...
import FilasTareas from './compoment/FilasTareas';
import Control from './compoment/Control';
import CreadorTareas from './compoment/CreadorTareas';
import Tareas from './compoment/Tareas';

const App= ()=> {
    const [nombreUsuario, setNombreUsuario] = useState('Eliana');
    ...
    useEffect(() => {
        ...
        if (datos != null) {
            ...
            setNombreUsuario('Ejemplos de Eliana');
            setTareasItems([
